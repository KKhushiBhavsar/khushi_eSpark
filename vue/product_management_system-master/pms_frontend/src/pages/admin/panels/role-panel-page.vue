      ...
      <template v-slot:content>
        <v-row class="mt-4">
          <v-col cols="12" v-for="role in roleList" :key="role.id">
            <v-card
              class="d-flex align-center blue-grey-darken-4"
              elevation="1"
            >
          ...
          >
            <v-btn @click="onShowRoleForm" color="blue-grey-darken-4">
              Add Role
  ...
  >
    <template v-slot:main>
      <v-form ref="form" @submit.prevent="onAddNewRole">
        ...
        <v-btn type="submit" color="blue-grey-darken-4" class="flex-grow-1 ma-3"
          >Submit</v-btn
        >
      </v-form>
    </template>
